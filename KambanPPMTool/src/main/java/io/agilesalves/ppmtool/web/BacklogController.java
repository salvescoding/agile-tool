...
public class BacklogController {
    ...
    public ResponseEntity<?> deleteProjectByProjectSequence(@PathVariable String projectTaskSequence) {
        projectTaskService.deleteProjectTaskByPTSequence(projectTaskSequence);
